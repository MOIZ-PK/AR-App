    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if((getIntent().getIntExtra("type", 0)) == 1){
            ...
            /*
             ...
             originalPrice = 8
            */
            binding.augment1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent;
                    intent = new Intent(DetailActivity.this, Augment1.class);
                        ...
                        new AlertDialog.Builder(DetailActivity.this)
                                ...
                                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        if (isInserted)
                                            Toast.makeText(DetailActivity.this, "Order successfull you will shortly receive your order", Toast.LENGTH_SHORT).show();
                                        else
